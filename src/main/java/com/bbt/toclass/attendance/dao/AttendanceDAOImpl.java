...
public class AttendanceDAOImpl implements AttendanceDAO {
	...
	public List<String> getStuEmails(String email) {
		return sqlSession.selectList("mapper.attendance.getStuEmails", email);
	}
	
	public AttendVO getStuNames(String email) {
		return sqlSession.selectOne("mapper.attendance.getStuNames", email);
	}
