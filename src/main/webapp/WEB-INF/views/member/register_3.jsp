...
<script>
	...
	function register() {
		// 우선 핸드폰 번호 유효성 확인
		if (emailDuplicateCheck && pwValidCheck && pwConfirmCheck && phoneValidCheck) {
...
<form name="frmRegister" method="post" action="${contextPath}/member/register.do">
	...
	비밀번호 확인 : <input id="member_pw_check" name="member_pw_check" type="password"/><b><span id="msgPwConfirm" style="font-size:0.6em"></span></b><br>
	<script>
