        ...
        <div class="navbar-collapse collapse" id="navbar_global">
            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                ...
                <li class="nav-item dropdown"><a href="#" class="nav-link"
                    ...
                    <div class="dropdown-menu">
                        <a href="${contextPath}/achievement/s_achievement" class="dropdown-item">성적분석</a>
                    </div>
                </li>
            </ul>
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">

                <li class="nav-item dropdown"><a href="${contextPath}/assignment/undefined" class="nav-link"
                                                 data-toggle="dropdown" href="#" role="button"> <i
                        class="ni ni-collection d-lg-none"></i> <span
            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                ...
                <li class="nav-item dropdown"><a href="#" class="nav-link"
                    ...
                    <div class="dropdown-menu">
                    	<!-- 현재 memberService.listArticles 오류로 인해 글목록 출력 안 되도록 임시 변경-->
                        <a href="${contextPath}/board/undefined" class="dropdown-item">자유게시판</a>
                        <a href="${contextPath}/board/undefined" class="dropdown-item">질의문의</a>
                        <a href="${contextPath}/board/undefined" class="dropdown-item">정보</a> 
                        <a href="${contextPath}/board/undefined" class="dropdown-item">유머</a>
                    </div>
                </li>
            </ul>
