				...
				<div class="row">
					<div class="col-6 collapse-brand">
						<a class="navbar-brand" href="${contextPath}/main.do"><img
							src="${contextPath}/assets/img/brand/logo3.png"
							style="height: 60px;"></a>
					</div>
				...
				<li class="nav-item dropdown"><a href="#" class="nav-link"
					...
					<div class="dropdown-menu">
						<a href="${contextPath}/board/listArticles.do"
							class="dropdown-item">자유게시판</a> <a href="./examples/profile.html"
							class="dropdown-item">질의문의</a> <a
							href="${contextPath}/member/listMembers.do" class="dropdown-item">회원관리</a>
				...
				<c:choose>
					<c:when test="${logOn == true  && member!= null}">
						<li class="nav-item"><a class="nav-link"
							href="${contextPath}/myclass/teacher">학급 정보 <span
